        ...
        <footer className="footer">
            <div className="container">
                ...
                <div className="footer__line2">
                    ...
                    <div className="footer__nav">
                        <NavLink className='nav__link' to='https:/instagram.com'><img src="/icons/inst.svg" alt="" /></NavLink>
                        <NavLink className='nav__link' to='https:/linkedin.com'><img src="/icons/linkedin.svg" alt="" /></NavLink>
                        <NavLink className='nav__link' to='https:/facebook.com'><img src="/icons/fb.svg" alt="" /></NavLink>
                        <NavLink className='nav__link' to='https:/twitter.com'><img src="/icons/tweet.svg" alt="" /></NavLink>
                    </div>
                </div>
            </div>
        </footer>
