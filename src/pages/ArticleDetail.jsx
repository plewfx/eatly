    ...
    return (
        <main className="article-detail">
                ...
                <div className="container">
                    <div className="article-detail__head-info">
                        ...
                        <div className="article-detail__head-profile">
                            <img data-aos='fade-right' data-aos-delay='100' src={'/src/assets/' + profile.img + '.png'} alt={profile.name} />
                            <p data-aos='fade-right' data-aos-delay='200'>Written By</p>
                            <h6 data-aos='fade-right' data-aos-delay='300'>{profile.name}</h6>
                        </div>
                        <div data-aos='fade-right' data-aos-delay='400' className="article-detail__head-img" style={{ backgroundImage: 'url("/src/assets/articles/' + id + '.png")' }}></div>
                    </div>
                </div>
            </section>
            ...
            <section className="article-detail__controls">
                <div className="container">
                    <Link className={(params.id == 1) ? "button__simple disabled" : "button__simple"} to={`/blog/${previousId}`}>
                    ...
                    <Link className={(params.id == articlesData.length) ? "button__simple disabled" : "button__simple"} to={`/blog/${nextId}`}>
                        Next Article
