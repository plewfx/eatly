        ...
        <main className='restaurant-detail'>
            <section className="restaurant-info">
                <div className="container">
                    <div data-aos='fade-up' data-aos-delay='100' className="restaurant-info__image" style={{backgroundImage: 'url("/eatly/src/assets/restaurants/' + name.toLowerCase().replace(/\s/g, '-') + '.png")'}}></div>
                    <div className="restaurant-info__text">
                        ...
                        <button onClick={() => setBookMarked(prev => !prev)} className={bookMarked && 'active'}>
                            <img src={'/eatly/src/assets/icons/bookmark' + (bookMarked ? '-active.svg' : '.svg')} alt="Save" />
                        </button>
                    </div>
                </div>
            </section>
